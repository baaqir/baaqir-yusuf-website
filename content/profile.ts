export const profile = {
  ...
  description:
    "Baaqir Yusuf — founding GTM engineer at Stainless. A personal site about work, writing, music, travel, movies, and whatever else I find interesting.",
  heroIntro:
